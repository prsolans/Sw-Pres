var pagelist = '{' +
    ...
    '{ "pageSlug":"introScreen", "id": 1, "title": "Intro Screen", "filename": "index", "layout": "splash", "parent":"0", "background":"home" },' +
...
$(document).on("pagebeforecreate", function pagePrebuild() {
    ...
    load_page_info(PAGE_ID, fileDepth);
