...
function set_page_layout(pageLayout) {
    ...
    if (pageLayout == 'text-video') {
        ...
        $('#left-column').removeClass('col-sm-6').addClass('col-sm-6');
    ...
    if (pageLayout == 'text-image') {
        ...
        $('#right-column').removeClass('col-sm-6').addClass('col-sm-6');
